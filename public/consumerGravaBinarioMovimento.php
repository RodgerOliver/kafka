...
$topic = $consumer->newTopic("GravaBinarioMovimento", $topicConf);
...
function logError($data, $error) {
    ...
    $data['dados']['ADados'] = str_replace(array("\r", "\n"), '', $data['dados']['ADados']);
    ...
    file_put_contents($pasta_erro. "/gravaBinarioMovimento.log", $line, FILE_APPEND);
}
